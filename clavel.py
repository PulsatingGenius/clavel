...
def train(classifarg, star_classes, tr_ev_sets, features):
    ...
    for i in training_indexes:
        try:                        
            ...
            sys.exit('Error collecting the features for training.')
...
def train_and_predict(classifarg):
    ...
    # If the star information is not provided with a features file.
    if not classifarg.features_file_is_given:
        # Read from a file the information of stars.
        star_classes.read_stars_ids_and_classes()       
